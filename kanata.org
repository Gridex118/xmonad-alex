...
#+begin_src text
  (deflayer mousekeys
    XX
    XX  XX    XX   XX   XX  XX  XX   XX   XX   XX   XX  XX  XX  XX
    XX  @msup XX   XX   XX  XX  XX   mrgt XX   XX   XX  XX  XX  XX
    XX  mlft  mrgt lsft XX  XX  @msh @msj @msk @msl XX  XX  XX
    XX  @msdw XX   XX   XX  XX  XX   mlft XX   XX   XX      XX
  ...
  (defalias
    ...
    msup (mwheel-accel-up       3 600 1.1 0.9)
    msdw (mwheel-accel-down     3 600 1.1 0.9)
  )
#+end_src
The alias,
#+begin_src text
...
#+begin_src text
  (deflayermap (layoutswitch)
    ...
    2 @qwr)
#+end_src
These are permanent (non toggle) switches. The =QWERTY= layer also includes a tap dance for switching to the =COLEMAK= layer
#+begin_src text
  (defalias
...
*** Niri Shortcuts
Tab switching can use a tap hold,
#+begin_src text
  (deflayermap mousetab
    mwu tab
    mwd S-tab)

  (defalias
    niritab (tap-hold-press 200 200
              A-tab
  			(multi lalt (layer-toggle mousetab))))
#+end_src

The niri shortcut layer, for overview, and tab switching
#+begin_src text
  (deflayer niri
     _       M-r
        M-o  M-q  @niritab
...
#+begin_src text
  (defalias
    mniri (tap-hold-press 200 200
            M-c
  		  (layer-toggle niri)))
#+end_src

*** Aliasing a Tap Dance for Niri and GIMP
#+begin_src text
  (defalias
    mgimp (tap-dance 200
